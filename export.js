...
async function main() {
    ...
    try {
        ...
        var recordingTitle = await page.evaluate(() => {
        ...
        console.log("Record Duration: " + recDuration);
        ...
        // await page.$eval('#recording-title', element => console.log(element.innerText));
